...
// =============================================================================== 
// Author              :    Frankie.W
// Create Time         :    2017/8/7 17:59:09
// Update Time         :    2017/8/7 17:59:09
...
{
    public class FKLightenQueueProfile : FKDebugProfile
    {
        private IFKStatisticsService _StatisticsService;

        public FKLightenQueueProfile(Game game, Rectangle bounds) : base(game, bounds)
        {
        }
        ...
        {
            ProfileValues.Add(_StatisticsService.LightenQueue);
            ...
            CurrentValue = (int)_StatisticsService.LightenQueue;
        ...
        {
            SpriteBatch.DrawString(SpriteFont, "LigQ:" + CurrentValue, new Vector2(Bounds.Left, Bounds.Bottom), Color.White);
