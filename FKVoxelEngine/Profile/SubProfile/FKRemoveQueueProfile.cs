...
// =============================================================================== 
// Author              :    Frankie.W
// Create Time         :    2017/8/7 18:03:49
// Update Time         :    2017/8/7 18:03:49
...
{
    public class FKRemoveQueueProfile : FKDebugProfile
    {
        private IFKStatisticsService _StatisticsService;

        public FKRemoveQueueProfile(Game game, Rectangle bounds) : base(game, bounds)
        {
        }
        ...
        {
            ProfileValues.Add(_StatisticsService.RemoveQueue);
            ...
            CurrentValue = (int)_StatisticsService.RemoveQueue;
        ...
        {
            SpriteBatch.DrawString(SpriteFont, "RemQ:" + CurrentValue, new Vector2(Bounds.Left, Bounds.Bottom), Color.White);
