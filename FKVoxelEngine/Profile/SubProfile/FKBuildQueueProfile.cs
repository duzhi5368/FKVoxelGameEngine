...
// =============================================================================== 
// Author              :    Frankie.W
// Create Time         :    2017/8/7 16:18:55
// Update Time         :    2017/8/7 16:18:55
...
{
    public class FKBuildQueueProfile : FKDebugProfile
    {
        private IFKStatisticsService _StatisticsService;

        public FKBuildQueueProfile(Game game, Rectangle bounds) : base(game, bounds)
        {
        }
        ...
        {
            ProfileValues.Add(_StatisticsService.BuildQueue);
            ...
            CurrentValue = (int)_StatisticsService.BuildQueue;
        ...
        {
            SpriteBatch.DrawString(SpriteFont, "BuiQ:" + CurrentValue, new Vector2(Bounds.Left, Bounds.Bottom), Color.White);
