...
// =============================================================================== 
// Author              :    Frankie.W
// Create Time         :    2017/8/7 17:56:22
// Update Time         :    2017/8/7 17:56:22
...
{
    public class FKGenerateQueueProfile : FKDebugProfile
    {
        private IFKStatisticsService _StatisticsService;

        public FKGenerateQueueProfile(Game game, Rectangle bounds) : base(game, bounds)
        {
        }
        ...
        {
            ProfileValues.Add(_StatisticsService.GenerateQueue);
            ...
            CurrentValue = (int)_StatisticsService.GenerateQueue;
        ...
        {
            SpriteBatch.DrawString(SpriteFont, "GenQ:" + CurrentValue, new Vector2(Bounds.Left, Bounds.Bottom), Color.White);
