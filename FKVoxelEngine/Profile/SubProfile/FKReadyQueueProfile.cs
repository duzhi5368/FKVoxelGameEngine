...
// =============================================================================== 
// Author              :    Frankie.W
// Create Time         :    2017/8/7 18:03:31
// Update Time         :    2017/8/7 18:03:31
...
{
    public class FKReadyQueueProfile : FKDebugProfile
    {
        private IFKStatisticsService _StatisticsService;

        public FKReadyQueueProfile(Game game, Rectangle bounds) : base(game, bounds)
        {
        }
        ...
        {
            ProfileValues.Add(_StatisticsService.ReadyQueue);
            ...
            CurrentValue = (int)_StatisticsService.ReadyQueue;
        ...
        {
            SpriteBatch.DrawString(SpriteFont, "ReaQ:" + CurrentValue, new Vector2(Bounds.Left, Bounds.Bottom), Color.White);
