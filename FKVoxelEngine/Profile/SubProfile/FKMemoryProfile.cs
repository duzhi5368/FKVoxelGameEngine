...
// =============================================================================== 
// Author              :    Frankie.W
// Create Time         :    2017/8/7 14:34:22
// Update Time         :    2017/8/7 14:34:22
...
{
    public class FKMemoryProfile : FKDebugProfile
    {
        private IFKStatisticsService _StatisticsService;

        public FKMemoryProfile(Game game, Rectangle bounds) : base(game, bounds)
        {
        }
        ...
        {
            ProfileValues.Add(_StatisticsService.MemoryUsed);
            ...
            CurrentValue = (int)_StatisticsService.MemoryUsed;
        ...
        public override void DrawString(GameTime gameTime)
        {
            ...
            SpriteBatch.DrawString(SpriteFont, "Min:" + MinValue.GetKiloString(), new Vector2(Bounds.Left + 210, Bounds.Bottom), Color.White);
        }
    }
}